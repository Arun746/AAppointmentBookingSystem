      ...
      <div class="col-sm-8">
       ...
       {{$errors}}
          <form method="post" action="{{route('doctors.store')}}" enctype="multipart/form-data" >
            ...
            <a href="#" class="btn btn-info btn-sm float-right" onclick="toggleFormOne()" id="toggleFormOne">Next</a>
            </div>
            </div>
            ...
            <div class="form-col">
               ...
               <div class="form-col">
                ...
                <input type="text" id="board" name="board" class="form-control" value="{{old('board')}}"/>
                @error('board')
                <span class="text-danger">{{ $message }}</span>
                @enderror
              </div>
              ...
              <div class="form-col">
                ...
                <input type="text" id="institution" name="institution" class="form-control" value="{{old('institution')}}"/>
                @error('institution')
                <span class="text-danger">{{ $message }}</span>
                @enderror
              </div>
              ...
              <div class="form-col">
                ...
                <input type="year" id="completion_year" name="completion_year" class="form-control" value="{{old('completion_year')}}"/>
              ...
              <div class="form-col">
                ...
                <input type="number" id="gpa" name="gpa" class="form-control" value="{{old('gpa')}}"/>
                @error('gpa')
                <span class="text-danger">{{ $message }}</span>
                @enderror
              </div>
            ...
            <div class="card-footer">
            <a href="#" class="btn btn-info btn-sm float-left" onclick="toggleFormOne()" id="toggleFormOne">Previous</a>
            <a href="#" class="btn btn-info btn-sm float-right" onclick="toggleFormTwo()" id="toggleFormTwo">Next</a>
            </div>
            </div>
            ...
            <div class="form-col">
              ...
              <div class="form-col">
                ...
                <input type="textarea" id="job_description" name="job_description" class="form-control" value="{{old('job_description')}}"/>
            ...
            <div class="card-footer">
            <a href="#" class="btn btn-info btn-sm float-left" onclick="toggleFormTwo()" id="toggleFormTwo">Previous</a>
            <a href="#" class="btn btn-info btn-sm float-right" onclick="toggleFormThree()" id="toggleFormThree">Next</a>
            </div>
            </div>
            ...
            <div class="card-footer">
            <a href="#" class="btn btn-info btn-sm float-left" onclick="toggleFormThree()" id="toggleFormThree">Previous</a>
